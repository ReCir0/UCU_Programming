...
def first_act(health, points, nickname):
    ...
    print()
    input("Late night, {} has fallen asleep. But then you go to your fridge and realise that all donuts have been eaten. Press enter\n>>> ".format(nickname))
...
def second_act(max_health, health, damage, points, coke, nickname):
    ...
    input("{}, you find yourself in a strange place\n>>> ".format(nickname))
        ...
        if your_action_1 == "1":
            ...
            while True:
                if your_action_2 == "1":
                    ...
                    input("\"The world needs you, the Golden Warrior {}\"\n>>> ".format(nickname))
                    break
                elif your_action_2 == "2":
                    input("\"I have read about you. You are the one who has the power that will defeat the monsters\n>>> ")
                    input("The Golden Warrior {}. Let me walk you through the island\"\n>>> ".format(nickname))
                    break
                else:
                    your_action_2 = input("Please, enter your choise again: \n>>> ")
            ...
            input("The Golden Donut. {}. Let me walk you through the island\"\n>>> ".format(nickname))
            # You get different amount of points that depend on your choice
            points += 20
    ...
    if your_action_1 == "1" or your_action_1 == "2" or your_action_3 == "1":
        ...
        input("Your attack deals {} damage, you have {} health. His damage is 5, health – 60\n>>> ".format(damage, health))
        ...
        input("health\n>>> ")
        input("And you have {}/{} health left\n>>> ".format(health, max_health))
        print()
        ...
        if item == "health":
            ...
            print("Your damage has increased! Now it is", damage, end = " ")
            damage += 5
            input("\n>>> ")
        # Adding points
        points += 50
...
to break his shield and deal two times more damage!")
    ...
    while True:
        ...
        if is_active_shield:
            print()
            input("You have got {} damage from the boss!\n>>> ".format(boss_damage / 2))
            print()
        ...
        input("Your health: {}. His health: {}\n>>> ".format(health, boss_health))
        print()
        ...
        if is_more_damage:
            input("You have dealt {} damage to the boss!\n>>> ".format(damage * 2))
